...
func (r ApiCreateWorkflowTemplateParserRequest) Execute() (WorkflowTemplateParser, *_nethttp.Response, error) {
...
*/
func (a *WorkflowApiService) CreateWorkflowTemplateParser(ctx _context.Context) ApiCreateWorkflowTemplateParserRequest {
	return ApiCreateWorkflowTemplateParserRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *WorkflowApiService) CreateWorkflowTemplateParserExecute(r ApiCreateWorkflowTemplateParserRequest) (WorkflowTemplateParser, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
